...
char checkWin(char*** board, int SIZE)
{
  ...
  for(int k=0;k<SIZE;k++)//平面对角线 情况1.1
  {
    int i=0,count=0;
    for(;i<SIZE;i++)
    {
  ...
  for(int k=0;k<SIZE;k++)//平面对角线 情况1.2
  {
    int count=0;
  ...
  for(int i=0;i<SIZE;i++)//平面对角线 情况2.1
  {
    int k=0,count=0;
    for(;k<SIZE;k++)
    {
  ...
  for(int i=0;i<SIZE;i++)//平面对角线 情况2.2
  {
    int count=0;
  ...
  for(int j=0;j<SIZE;j++)//平面对角线 情况3.1
  {
    int i=0,count=0;
    for(;i<SIZE;i++)
    {
  ...
  for(int j=0;j<SIZE;j++)//平面对角线 情况3.2
  {
    int count=0;
    for(int i=SIZE-1;i>=0;i--)
    {
  ...
  int count=0;
  for(int i=0;i<SIZE;i++) //切面对角线 情况1
  {
  ...
  count=0;
  for(int i=SIZE-1;i>=0;i--) //切面对角线 情况2
  {
  ...
  count=0;
  for(int i=0;i<SIZE;i++) //切面对角线 情况3
  {
  ...
  count=0;
  for(int i=0;i<SIZE;i++) //切面对角线 情况4
  {
